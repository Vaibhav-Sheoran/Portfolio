export default function ContactButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="rounded-full px-6 py-2.5 sm:px-10 sm:py-3.5 md:px-12 md:py-4 text-xs sm:text-sm md:text-base text-white font-medium uppercase tracking-widest cursor-pointer"
      style={{
